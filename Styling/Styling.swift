...
struct Styling {
    ...
    static let secondaryColor = UIColor(red: 0.443, green: 0.788, blue: 0.808, alpha: 1.0)
    static let secondaryBackgroundColor = UIColor(red: 0.651, green: 0.890, blue: 0.914, alpha: 1.0)
